        ...
        <div className="detail-content">
          ...
          <section className="section-block privacy-cta">
            <div className="section-header">
              ...
              <p>Review how we handle data, billing, and your rights as a subscriber.</p>
            </div>
            <div className="cta-row">
              <a className="cta primary" href={`/${app.slug}/privacy`}>Privacy Policy</a>
              <a className="cta ghost" href={`/${app.slug}/terms`}>Terms of Use (EULA)</a>
            </div>
          </section>
        </div>
      </div>
