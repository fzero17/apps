export const privacyPolicies = {
  snapmulti: {
    ...
    overview: 'SnapMulti is a camera utility for front/back capture and multi-ratio photo export. The app is designed to process camera preview frames and generated photos on your device. We do not operate a user account system and do not upload your photos or live camera preview to developer servers.',
    sections: [
      {
        title: 'Data We Collect',
        body: [
          'SnapMulti does not collect personal identifiers, account information, advertising identifiers, contact lists, or analytics data for tracking.',
          'Photos, camera preview frames, crop positions, selected aspect ratios, and generated exports are processed on device for the purpose of capture, preview, save, and share workflows.',
          'The app does not send your camera preview or captured photos to developer-controlled servers.'
        ]
      },
      {
        title: 'Camera and Photo Permissions',
        body: [
          'Camera access is required to show the viewfinder and capture photos.',
          'Photo library add-only access is requested only when you choose to save selected images to your device photo library.',
          'The app can be used without creating an account. If you deny optional photo library permission, camera capture can still work, but saving to the library may be unavailable.'
        ]
      },
      {
        title: 'Purchases',
        body: [
          'SnapMulti Pro Lifetime is provided through Apple in-app purchase.',
          'Purchase entitlement status and restoration are managed through RevenueCat, while payment processing is handled by Apple and your App Store account.',
          'RevenueCat may process purchase identifiers and entitlement status so SnapMulti can unlock Pro features. We do not receive or store your payment card information.'
        ]
      },
      {
        title: 'Local Storage',
        body: [
          'The app may store local settings such as trial state, selected camera options, crop positions, and preferences on your device.',
          'Deleting the app removes local app data from the device, subject to normal iOS backup and restore behavior.'
        ]
      },
      {
        title: 'Sharing',
        body: [
          'Photos are shared only when you choose to use the iOS share sheet or save them to the photo library.',
          'When you share through another app or service, that destination is governed by its own privacy policy.'
        ]
      },
      {
        title: 'Diagnostics',
        body: [
          'If you opt in to share diagnostics with developers through Apple settings, Apple may provide crash logs or diagnostic information. These reports are used to improve stability and do not include your camera photos.',
          'You can manage this option in iOS Settings under Privacy & Security, Analytics & Improvements.'
        ]
      },
      {
        title: 'Children',
        body: [
          'SnapMulti is a general-purpose camera utility and is not directed at children under 13.',
      ...
      },
      {
        title: 'Contact',
        body: [
          'For privacy questions or support, contact fzero17@qq.com.',
          'Please avoid sending private photos unless they are necessary to diagnose a support issue.'
        ]
      }
    ]
  },
  ...
  metmark: {
    ...
    overview: 'MetMark is designed as a private personal record of the people you meet, places you visit, notes, photos, and related memories. Your records are used to power your timeline, map, people views, search results, and memory collections.',
    sections: [
      {
        title: 'Data You Add',
        body: [
      ...
      },
      {
        title: 'Contact',
        body: [
          'For privacy questions or support, contact wshutalk@gmail.com.'
        ]
      }
    ]
  },
  'aa-assistant': {
    ...
    platform: 'iOS',
    overview: 'AA Assistant is a bill splitting tool designed for travel, parties, and daily life. The app operates entirely offline and stores all data locally on your device. We do not collect, store, or transmit any personal information.',
    sections: [
      {
      ...
      },
      {
        title: 'Contact Us',
        body: [
          'If you have any questions about this Privacy Policy, please contact us at fzero17@qq.com.'
        ]
      }
    ]
  }
