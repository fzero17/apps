export const privacyPolicies = {
  duocamera: {
    ...
    overview: 'SnapMulti / 同摄 is a camera utility for front/back capture and multi-ratio photo export. The app is designed to process camera preview frames and generated photos on your device. We do not operate a user account system and do not upload your photos or live camera preview to developer servers.',
    sections: [
      {
      ...
      },
      {
        ...
        body: [
          ...
          'Purchase processing, payment information, transaction history, and restoration are handled by Apple StoreKit and your App Store account.',
          'SnapMulti checks StoreKit entitlement status to unlock Pro features. We do not receive or store your payment card information.'
        ]
      },
      {
        title: 'Local Storage',
