    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'All data storage is local-first. No data is sent to external servers, cloud services (except iCloud if you enable it), or third-party providers.',
          'If you enable iCloud sync in System Settings, macOS automatically syncs your favorites to iCloud using Apple\'s CloudKit framework. This is controlled entirely by macOS and not by OpenFolder.'
        ]
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          'OpenFolder does NOT use the following services: Google Analytics, Firebase, Facebook SDK, Mixpanel, Amplitude, Sentry, or any advertising networks.',
          'If you enable iCloud sync, data is synced using Apple\'s CloudKit service (part of macOS). OpenFolder does not access or control this data beyond standard CloudKit APIs.'
        ]
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          'If iCloud sync was enabled, synced data remains in your iCloud account until you delete it. To remove synced data: System Settings → Apple ID → iCloud → Manage Storage → OpenFolder → Delete Documents & Data.',
      ...
      },
      {
        ...
        body: [
          ...
          'Opt-out: You can disable iCloud sync, analytics sharing, and crash reporting at any time through macOS System Settings.',
