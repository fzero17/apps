export const apps = [
  ...
  // },
  {
    ...
    description: 'SnapMulti is a focused camera utility for creators who need front/back capture and multi-ratio output in one workflow. Capture with one or two cameras, frame multiple aspect ratios, preview each result, and save or share the outputs that fit your post, story, profile, or archive.',
    ...
    featureSections: [
      ...
      },
      {
        ...
        bullets: [
          'RevenueCat manages purchase status and restoration',
          'No account required',
          'Photo library access is used only when you save selected images'
        ],
        image: '/images/duocamera/paywall.png',
        imageAlt: 'SnapMulti one-screen Pro paywall with RevenueCat purchase',
        align: 'right'
      }
    ],
    whatsNew: [
