export const apps = [
  ...
  // },
  {
    ...
    hero: {
      ...
      ctas: [
        { label: 'Get on the App Store', href: 'https://apps.apple.com/', kind: 'primary' }
      ]
    },
    featureSections: [
      {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: 'OpenFolder supports macOS Ventura (13.0) and newer, optimized for Apple silicon and Intel machines alike.'
      },
      {
