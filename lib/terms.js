    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'Configuration data is stored locally on your device and synced using Apple services only if you explicitly enable iCloud syncing in macOS preferences.',
      ...
      },
      {
        ...
        body: [
          ...
          'No third-party analytics, advertising, or tracking SDKs are integrated into OpenFolder. The app does not use Firebase, Google Analytics, Facebook SDK, or similar services.',
          'If you enable iCloud sync in System Settings, your favorites and preferences are synced using Apple\'s iCloud service, subject to Apple\'s iCloud Terms of Service.',
      ...
      },
      {
        ...
        body: [
          ...
          'Security-scoped bookmarks are used to maintain access to files and folders you\'ve added. These are encrypted by macOS and never leave your device unless you enable iCloud sync.',
