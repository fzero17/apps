export const terms = {
  snapmulti: {
    updated: 'May 27, 2026',
    overview: 'These Terms of Use govern your download and use of SnapMulti for iOS, including the optional SnapMulti Pro Lifetime in-app purchase. SnapMulti also follows the Apple Standard Licensed Application End User License Agreement.',
    subscription: {
      title: 'Purchase overview',
      items: [
        'SnapMulti Pro Lifetime is a non-consumable one-time purchase sold through the App Store and managed through RevenueCat.',
        'The free version remains usable without purchase for supported camera capture and preview workflows.',
        'Pro unlocks dual-camera layouts, custom crop positioning, composition tools, and all supported export formats.',
        'Purchases can be restored from the app on devices signed in with the same Apple ID.'
      ]
    },
    sections: [
      {
        title: 'Usage',
        body: [
          'SnapMulti is provided for personal photo capture, preview, save, and share workflows.',
          'You are responsible for reviewing the photos you create and for complying with applicable laws and venue rules when recording people, documents, events, or locations.',
          'Do not use SnapMulti to capture or distribute content that you do not have the right to create or share.'
        ]
      },
      {
        title: 'Billing and restoration',
        body: [
          'All purchases are charged to your Apple ID at confirmation of purchase. RevenueCat manages entitlement status and restoration, while payment is handled by Apple through the App Store.',
          'SnapMulti does not process or store payment card details.',
          'The app includes Restore Purchases so you can restore the Lifetime unlock on devices signed in with the same Apple ID.'
        ]
      },
      {
        title: 'Device compatibility',
        body: [
          'Some camera capabilities, including simultaneous front and back capture, depend on device support from iOS and the underlying hardware.',
          'If a device does not support simultaneous dual-camera capture, single-camera workflows may still be available.'
        ]
      },
      {
        title: 'Availability and changes',
        body: [
          'Features, supported layouts, export formats, and Pro unlocks may change as the app evolves.',
          'We may update these Terms of Use to reflect product, legal, or policy changes.',
          'Continuing to use SnapMulti after changes take effect means you accept the revised terms.'
        ]
      },
      {
        title: 'Disclaimer',
        body: [
          'SnapMulti is provided "as is" without warranties of any kind.',
          'We are not liable for lost photos, device limitations, missed captures, or disputes arising from how captured images are used.',
          'For support, contact fzero17@qq.com.'
        ]
      }
    ],
  ...
  metmark: {
    updated: 'May 16, 2026',
    overview: 'These Terms of Use govern your download and use of MetMark for iOS, including the optional MetMark Pro Lifetime in-app purchase. MetMark also follows the Apple Standard Licensed Application End User License Agreement.',
    subscription: {
      title: 'Purchase overview',
      items: [
        'MetMark Pro Lifetime is a non-consumable one-time purchase processed through the App Store.',
        'The free version remains usable without purchase and lets users add people and record moments within the free limit.',
        'Pro unlocks higher limits, optional iCloud sync, memory collections, and richer relationship insights.'
      ]
    },
    sections: [
      {
        title: 'Usage',
        body: [
          'MetMark is provided for personal record keeping and reflection around real-world meetings, relationships, locations, notes, and photos.',
          'You are responsible for the accuracy and appropriateness of any information you enter into the app.',
          'Do not use MetMark to store information you are not legally allowed to possess or process.'
        ]
      },
      {
        title: 'Billing and restoration',
        body: [
          'All purchases are charged to your Apple ID at confirmation of purchase and are handled by Apple through the App Store.',
          'MetMark does not process or store payment card details.',
          'The app includes Restore Purchases so you can restore the Lifetime unlock on devices signed in with the same Apple ID.'
        ]
      },
      {
        title: 'Data and iCloud',
        body: [
          'Your records are stored locally on your device by default.',
          'Optional iCloud sync may sync your data through your private iCloud account using Apple CloudKit infrastructure.',
          'You are responsible for maintaining device backups and iCloud account security.'
        ]
      },
      {
        title: 'Availability and changes',
        body: [
          'Features, limits, supported languages, and Pro unlocks may change as the app evolves.',
          'We may update these Terms of Use to reflect product, legal, or policy changes.',
          'Continuing to use MetMark after changes take effect means you accept the revised terms.'
        ]
      },
      {
        title: 'Disclaimer',
        body: [
          'MetMark is provided "as is" without warranties of any kind.',
          'We are not liable for data loss, missed reminders, relationship decisions, or disputes arising from your use of the app.',
          'For support, contact wshutalk@gmail.com.'
        ]
      }
    ],
    eulaUrl: 'https://www.apple.com/legal/internet-services/itunes/dev/stdeula/',
    supportEmail: 'wshutalk@gmail.com'
  },
  openfolder: {
  ...
  'aa-assistant': {
    ...
    overview: 'By downloading or using AA Assistant, you agree to the standard Apple Media Services Terms and Conditions (EULA).',
    sections: [
      {
        title: 'Usage',
        body: [
          'AA Assistant is provided for personal use to assist with bill splitting and expense tracking.',
          'You are responsible for the accuracy of the data entered into the app.'
        ]
      },
      {
        title: 'In-App Purchases',
        body: [
          'The app may offer in-app purchases for additional features or to support development.',
          'All transactions are processed securely by Apple via the App Store.'
        ]
      },
      {
        title: 'Disclaimer',
        body: [
          ...
          'We are not responsible for any financial discrepancies or disputes arising from the use of this app.'
        ]
      }
    ],
    eulaUrl: 'https://www.apple.com/legal/internet-services/itunes/dev/stdeula/',
