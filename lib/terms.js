export const terms = {
  duocamera: {
    updated: 'May 27, 2026',
    overview: 'These Terms of Use govern your download and use of SnapMulti / 同摄 for iOS, including the optional SnapMulti Pro Lifetime in-app purchase. SnapMulti also follows the Apple Standard Licensed Application End User License Agreement.',
    subscription: {
      title: 'Purchase overview',
      items: [
        'SnapMulti Pro Lifetime is a non-consumable one-time purchase processed through the App Store.',
